...
public:
  ...
  void setGaitNum(int gaitNum){gaitNumber = gaitNum % 8; if(gaitNum%8 ==0) gaitNumber = 8; return;}
...
protected:
  ...
  Gait trotting, bounding, pacing, walking, galloping, pronking, standing, two_foot_trot;
